                ...
                <div class="row">
                  <div class="col-12 col-lg-7">
                    <div class="slide-content">
                      ...
                      <div class="slide-buttons"><a class="btn btn--white btn--inverse" href="page-about.php">more about us</a><a class="btn btn--transparent" href="contact.php">Contact Us</a></div>
                    </div>
                    <!-- End .slide-content -->
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-12 col-lg-7">
                    <div class="slide-content">
                      ...
                      <div class="slide-buttons"><a class="btn btn--primary" href="page-about.php">more about us</a><a class="btn btn--white" href="contact.php">Contact Us</a></div>
                    </div>
                    <!-- End .slide-content -->
                  </div>
                </div>
                  ...
                  <div class="contact-body trackFormActive">
                    <div class="row">
                      <div class="col-12 col-lg-8">
                        ...
                        <form class="contactForm track-form-x mb-0" action="tracking-result.php" id="userForm" method="post">
                      ...
                      <div class="col-12 col-lg-4">
                        <div class="apply-card widget widget-reservation"><img src="assets/images/contact/1.jpg" alt="image"/>
                          <div class="widget-content">
                            ...
                            <p>We pride ourselves on providing the best transport & shipping services available all over the world and there is no one comes close to us. </p><a class="btn btn--white" href="page-careers.php"><i class="icon-arrow-right"></i>apply now!</a>
                          </div>
                        </div>
                      </div>
                    </div>
